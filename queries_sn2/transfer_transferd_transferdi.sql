-- residual_check
-- transfer | transfer_draft | transfer_draft_item
SELECT ch.birth_certificate AS child_BC, trd.*,tr.*,tdi.* FROM {ARCHIVED_SN2_DB}.child ch
...
-- transfer | transfer_draft | transfer_draft_item
SELECT ch.birth_certificate AS child_BC, trd.*,tr.*,tdi.* FROM {SOURCE_SN2_DB}.child ch
