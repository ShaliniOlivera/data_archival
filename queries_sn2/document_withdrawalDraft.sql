...
INNER JOIN {ARCHIVED_SN2_DB}.withdrawal_draft wd ON wd.id = dty.fk_withdrawal_draft
...
INNER JOIN {SOURCE_SN2_DB}.withdrawal_draft wd ON wd.id = dty.fk_withdrawal_draft
