-- residual_check
-- marketing_consent_business_entity
...
INNER JOIN {ARCHIVED_SN2_DB}.marketing_consent_business_entity mcaul ON mcaul.fk_marketing_consent = mc.id
...
INNER JOIN {SOURCE_SN2_DB}.marketing_consent_business_entity mcaul ON mcaul.fk_marketing_consent = mc.id
