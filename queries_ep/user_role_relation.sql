...
INNER JOIN `skoolnet2_archival_mfs_ep_20250425`.user_role_relation uac ON uac.fk_user = u.id
...
INNER JOIN `skoolnet2_archival_mfs_ep_20250425_org`.user_role_relation uac ON uac.fk_user = u.id
WHERE ch.id NOT IN(
