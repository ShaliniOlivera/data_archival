-- residual_check
-- enrichment_class_child_document
SELECT *
FROM {ARCHIVED_SN2_DB}.child ch
INNER JOIN {ARCHIVED_SN2_DB}.enrichment_class_child ecc ON ecc.fk_child = ch.id
INNER JOIN {ARCHIVED_SN2_DB}.enrichment_class_child_document eca ON eca.fk_enrichment_class_child = ecc.id
...
INNER JOIN {SOURCE_SN2_DB}.enrichment_class_child_document eca ON eca.fk_enrichment_class_child = ecc.id
