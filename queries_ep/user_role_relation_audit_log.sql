-- residual_check
-- user_role_relation_audit_log
SELECT ch.birth_certificate, ural.*
...
INNER JOIN {ARCHIVED_SN2_DB}.user_role_relation_audit_log ural ON ural.user_role_relation_id = uac.id
...
INNER JOIN {SOURCE_SN2_DB}.user_role_relation_audit_log ural ON ural.user_role_relation_id = uac.id
